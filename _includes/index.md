...
<div class="center-align bottom-appeal">
  <a href="{{ site.root }}/contact" class="waves-effect waves-default btn white grey-text text-darken-4 modal-trigger">{{ site.data.front_page.contact_us_section.button_text }}</a>
</div>
